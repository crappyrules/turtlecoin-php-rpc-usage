...
<html lang="en">
  ...
  <body>
    ...
    <p>
      <center>
      <img src="img/logo.png" alt="TurtleCoin">
    </center>
    </p>
    </div>
    <br />
    <div class="container-fluid">
  <h2>Your available balance is: <?php echo $balance . " TRTL" . " (" . $balance * $response["result"][0]["price"] . " $)"; ?> </h2>
  <h3><p>Your locked balance is: <?php echo $lbalance . " TRTL" . " (" . $lbalance * $response["result"][0]["price"] . " $)"; ?></p>
  <p>Daemon status: <?php echo $sblocks . " of " . $bcount . " blocks synced"; ?></p>
   <div class="row">
     <div class="col"><a href="transact.php"><img src="img/transfer.png" alt="Send Turtle"></a></div>
